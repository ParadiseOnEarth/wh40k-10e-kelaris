...
<gameSystem xmlns="http://www.battlescribe.net/schema/gameSystemSchema" id="sys-352e-adc2-7639-d6a9" name="40k 10e Kelaris Campaign Homebrew" revision="78" battleScribeVersion="2.03" type="gameSystem">
  <publications>
  ...
  <categoryEntries>
    ...
    <categoryEntry name="Inquisition" id="42fb-b644-0d04-b0b9" hidden="false"/>
  </categoryEntries>
  <forceEntries>
